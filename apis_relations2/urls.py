...
urlpatterns = [
        ...
        path('relationtype/<int:contenttype>/to/<int:toobj>', views.RelationView.as_view(), name='relationto'),
        ...
        path('relationtype/<int:contenttype>/to/<int:toobj>/partial', views.RelationViewPartial.as_view(), name='relationpartialto'),
